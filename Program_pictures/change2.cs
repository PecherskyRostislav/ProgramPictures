...
namespace Program_pictures
{
    ...
    {
        public change2(Image img, Rectangle z)
        {
            InitializeComponent();
        ...
        {
            Harshness2 BrightnessForm = new Harshness2(this);
        ...
        {
            color_balance2 ColorBalanceForm = new color_balance2(this);
            ColorBalanceForm.ShowDialog();
        }

        private void change2_FormClosing(object sender, FormClosingEventArgs e)
        {
            picture.schet--;
            picture.prov[2] = true;
            if (proverca)
        ...
        private void підтвердитиToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            picture.stat_rec = picture.zed[2];
            ...
            g1.DrawImage(bm1, picture.zed[2]);
